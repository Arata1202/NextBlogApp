...
describe('search app page', () => {
  ...
  it('renders the search fallback as loading while the client search page is suspended', async () => {
    ...
    expect(document.querySelector('[data-app-search-index-fallback]')).toBeInTheDocument();
    expect(document.querySelector('[data-search-loading-fallback]')).toBeInTheDocument();
  });
});
