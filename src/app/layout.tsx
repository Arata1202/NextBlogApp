    ...
    <html lang="ja" suppressHydrationWarning>
      ...
      <body>
        ...
        >
          ...
          <a
            href="#main-content"
            className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-100 focus:rounded-md focus:bg-white focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-blue-700 focus:shadow-lg focus:outline-hidden focus:ring-2 focus:ring-blue-600"
          >
            本文へスキップ
          </a>
          <Header />
